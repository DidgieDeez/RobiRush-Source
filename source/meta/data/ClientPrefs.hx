...
class ClientPrefs {
	...
	public static var fakeDesktop:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.fakeDesktop = fakeDesktop;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.fakeDesktop != null) {
			fakeDesktop = FlxG.save.data.fakeDesktop;
		}
