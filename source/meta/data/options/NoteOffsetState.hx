...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeBarBG = new FlxSprite(0, timeTxt.y + 18).loadGraphic(Paths.image('timeBar'));
		...
		timeBar = new FlxBar(0, timeBarBG.y + 30, LEFT_TO_RIGHT, 185, 20, this, 'barPercent', delayMin, delayMax);
