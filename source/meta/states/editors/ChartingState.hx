...
class ChartingState extends MusicBeatState
{
	...
	[
        ...
        ["Change Robi", "type the robi you want to change to, type anything else to switch back to og"],
        ["Walker Andy", "value 1: which robi\nvalue 2: how far \n\n(example: robiMARIO, -100)"],
        ["Spawn Robi", "value 1: which robi\n\n\nthats it"],
        ["Kill You", ""],
		["New Window", "Value 1: Window Name"], // THIS SHIT ASS
	];
